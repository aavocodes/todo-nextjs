    ...
    return (
        <div className={`${roboto.className}`}>
            ...
            <div className="flex h-screen flex-col md:flex-row md:overflow-hidden md:px-0 bg-special-600">
                <div className="w-full flex-col flex md:w-[45%]">
                    <TodoCompleter />
                </div>
                <div className="flex-grow md:overflow-y-auto md:px-0 text-center items-center bg-special-800 p-4 border-l border-special-300 md:h-full">
                    {children}
                </div>
            </div>
        </div>
