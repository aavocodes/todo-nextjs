...
export default function NavBar() {
    return (
        <nav className="fixed top-0 left-0 right-0 w-[96.4%] rounded-lg bg-special-600/30 backdrop-blur-md shadow-md py-3 px-4 flex items-center justify-between z-50 border-b border-l border-r border-special-500 mx-auto">
            ...
            <div className='ml-16'>
                <ul className="hidden md:flex text-special-50 text-sm border border-special-500 pl-0 py-0 overflow-hidden rounded-md justify-center">
