    ...
    return (
        <form className={`${roboto.className} space-y-3`}>
            <div className="flex-1 rounded-lg bg-special-600 border border-special-400 px-6 pb-4 pt-8">
                ...
                <button
                    type='submit'
                    className="mt-4 w-full bg-special-800 hover:bg-special-700 transition cursor-pointer text-gray-50 hover:text-special-50 border border-special-500 rounded-lg flex items-center justify-center space-x-2 py-2 px-3"

                >
                    Login <ArrowRightIcon className="ml-auto h-5 w-5 text-gray-50" />
                </button>
                <div className="flex h-8 my-2 justify-end  space-x-1">
