    ...
    return (
        <div>
            <button
                ...
                type={type}
                className={clsx(
                    actionButton && "text-special-50 cursor-pointer transition hover:bg-jade-800 focus:ring-4 font-medium rounded-md text-sm px-4 py-1.5 ml-0 mr-2 my-1 focus:outline-none",
                    bgColor,
